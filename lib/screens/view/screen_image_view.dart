...
class _GalleryPageState extends State<GalleryPage> {
  ...
  void initState() {
    ...
    super.initState();
    getData(widget.keyWord.toString());
    ...
    return Container(
      decoration: BoxDecoration(
          image: DecorationImage(
              image: NetworkImage("https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Image_created_with_a_mobile_phone.png/640px-Image_created_with_a_mobile_phone.png"), fit: BoxFit.cover)),
      child: Scaffold(
    ...
    String url = "https://pixabay.com/api/?"
       ...
       setState(() {
        ...
        if(imagesDate['totalHits']%size==0)
          ...
          totelPages=1+(imagesDate['totalHits']/size);
        }
